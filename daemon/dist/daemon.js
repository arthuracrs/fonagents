...
function startDaemon(opts = {}) {
    ...
    const mcpServerScript = path_1.default.resolve(__dirname, '../../adapters/http-sse/dist/mcp-server.js');
    ...
    const beadsUiDist = path_1.default.resolve(__dirname, '../../beads-ui/dist');
